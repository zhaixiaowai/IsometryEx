...
const defineMSLayerArray = typeof MSLayerArray!=='undefined';
export function applyTransform(layers, angle1, scaleX, scaleY, angle2) {
    ...
    var layerArray = defineMSLayerArray ? MSLayerArray.arrayWithLayers(layers) : layers;
        ...
        case "MSShapeGroup":
            {
                ...
                if(layer.fixGeometryWithOptions){
                    layer.fixGeometryWithOptions(1);
                }else if(layer.legacyFixGeometryWithOptions){
                    layer.legacyFixGeometryWithOptions(1);
                }
